...
Currently, the project provides a spreadsheet formula language parser/compiler, an error system, an
address system for worksheets and a (currently small) set of functions packaged individually as UMD modules.
